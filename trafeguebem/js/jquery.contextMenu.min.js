(function(e,k){function r(a){return a.id&&e('label[for="'+a.id+'"]').val()||a.name}function z(a,b,c){c||(c=0);b.each(function(){var b=e(this),g=this,j=this.nodeName.toLowerCase(),f,i;"label"==j&&b.find("input, textarea, select").length&&(f=b.text(),b=b.children().first(),g=b.get(0),j=g.nodeName.toLowerCase());switch(j){case "menu":i={name:b.attr("label"),items:{}};c=z(i.items,b.children(),c);break;case "a":case "button":i={name:b.text(),disabled:!!b.attr("disabled"),callback:function(){b.click()}};
...
"-------";break;case "input":switch(b.attr("type")){case "text":i={type:"text",name:f||r(g),disabled:!!b.attr("disabled"),value:b.val()};break;case "checkbox":i={type:"checkbox",name:f||r(g),disabled:!!b.attr("disabled"),selected:!!b.attr("checked")};break;case "radio":i={type:"radio",name:f||r(g),disabled:!!b.attr("disabled"),radio:!!b.attr("name"),value:b.val(),selected:!!b.attr("checked")};break;default:i=k}break;case "select":i={type:"select",name:f||r(g),disabled:!!b.attr("disabled"),selected:b.val(),
options:{}};b.children().each(function(){i.options[this.value]=e(this).text()});break;case "textarea":i={type:"textarea",name:f||r(g),disabled:!!b.attr("disabled"),value:b.val()};break;case "label":break;default:i={type:"html",html:b.clone(!0)}}i&&(c++,a["key"+c]=i)});return c}e.support.htmlMenuitem="HTMLMenuItemElement"in window;e.support.htmlCommand="HTMLCommandElement"in window;e.support.eventSelectstart="onselectstart"in document.documentElement;var h=null,t=!1,l=e(window),u=0,n={},q={},v={},
w={selector:null,appendTo:null,trigger:"right",autoHide:!1,delay:200,determinePosition:function(a){if(e.ui&&e.ui.position)a.css("display","block").position({my:"center top",at:"center bottom",of:this,offset:"0 5",collision:"fit"}).css("display","none");else{var b=this.offset();b.top+=this.outerHeight();b.left+=this.outerWidth()/2-a.outerWidth()/2;a.css(b)}},position:function(a,b,c){if(!b&&!c)a.determinePosition.call(this,a.$menu);else{"maintain"===b&&"maintain"===c?b=a.$menu.position():(a.$trigger.parents().andSelf().filter(function(){return"fixed"==
...
hide:"slideUp"},events:{show:e.noop,hide:e.noop},callback:null,items:{}},s=null,x=null,y=null,A,f={abortevent:function(a){a.preventDefault();a.stopImmediatePropagation()},contextmenu:function(a){var b=e(this);a.preventDefault();a.stopImmediatePropagation();if(!("right"!=a.data.trigger&&a.originalEvent)&&!b.hasClass("context-menu-disabled")){h=b;if(a.data.build){var c=a.data.build(h,a);if(!1===c)return;a.data=e.extend(!0,{},w,a.data,c||{});if(!a.data.items||e.isEmptyObject(a.data.items))throw window.console&&
(console.error||console.log)("No items specified to show in contextMenu"),Error("No Items sepcified");a.data.$trigger=h;p.create(a.data)}p.show.call(b,a.data,a.pageX,a.pageY)}},click:function(a){a.preventDefault();a.stopImmediatePropagation();e(this).trigger(e.Event("contextmenu",{data:a.data,pageX:a.pageX,pageY:a.pageY}))},mousedown:function(a){var b=e(this);h&&(h.length&&!h.is(b))&&h.data("contextMenu").$menu.trigger("contextmenu:hide");2==a.button&&(h=b.data("contextMenuActive",!0))},mouseup:function(a){var b=
e(this);b.data("contextMenuActive")&&(h&&h.length&&h.is(b)&&!b.hasClass("context-menu-disabled"))&&(a.preventDefault(),a.stopImmediatePropagation(),h=b,b.trigger(e.Event("contextmenu",{data:a.data,pageX:a.pageX,pageY:a.pageY})));b.removeData("contextMenuActive")},mouseenter:function(a){var b=e(this),c=e(a.relatedTarget),d=e(document);if(!c.is(".context-menu-list")&&!c.closest(".context-menu-list").length&&(!h||!h.length))x=a.pageX,y=a.pageY,A=a.data,d.on("mousemove.contextMenuShow",f.mousemove),s=
setTimeout(function(){s=null;d.off("mousemove.contextMenuShow");h=b;b.trigger(e.Event("contextmenu",{data:A,pageX:x,pageY:y}))},a.data.delay)},mousemove:function(a){x=a.pageX;y=a.pageY},mouseleave:function(a){a=e(a.relatedTarget);if(!a.is(".context-menu-list")&&!a.closest(".context-menu-list").length){try{clearTimeout(s)}catch(b){}s=null}},layerClick:function(a){var b=e(this),c=b.data("contextMenuRoot"),d=!1,g=a.button,j=a.pageX,f=a.pageY,i,h,k;a.preventDefault();a.stopImmediatePropagation();b.on("mouseup",
...
b.$selected=null}},p={show:function(a,b,c){var d=e(this),g={};e("#context-menu-layer").trigger("mousedown");a.$trigger=d;if(!1===a.events.show.call(d,a))h=null;else{p.update.call(d,a);a.position.call(d,a,b,c);if(a.zIndex){b=0;for(c=d;!(b=Math.max(b,parseInt(c.css("z-index"),10)||0),c=c.parent(),!c||!c.length||-1<"html body".indexOf(c.prop("nodeName").toLowerCase())););g.zIndex=b+a.zIndex}p.layer.call(a.$menu,a,g.zIndex);a.$menu.find("ul").css("zIndex",g.zIndex+1);a.$menu.css(g)[a.animation.show](a.animation.duration);
...
g=d.data("contextMenuKey"),f=a.items[g],g=e.isFunction(f.disabled)&&f.disabled.call(c,g,b)||!0===f.disabled;d[g?"addClass":"removeClass"]("disabled");if(f.type)switch(d.find("input, select, textarea").prop("disabled",g),f.type){case "text":case "textarea":f.$input.val(f.value||"");break;case "checkbox":case "radio":f.$input.val(f.value||"").prop("checked",!!f.selected);break;case "select":f.$input.val(f.selected||"")}f.$menu&&p.update.call(c,f,b)})},layer:function(a,b){var c=a.$layer=e('<div id="context-menu-layer" style="position:fixed; z-index:'+
...
a?(a=this.data("contextMenu").$menu)&&a.trigger("contextmenu:hide"):a?this.removeClass("context-menu-disabled"):a||this.addClass("context-menu-disabled");return this};e.contextMenu=function(a,b){"string"!=typeof a&&(b=a,a="create");"string"==typeof b?b={selector:b}:b===k&&(b={});var c=e.extend(!0,{},w,b||{}),d=e(document);switch(a){case "create":if(!c.selector)throw Error("No selector specified");if(c.selector.match(/.context-menu-(list|item|input)($|\s)/))throw Error('Cannot bind to selector "'+
c.selector+'" as it contains a reserved className');if(!c.build&&(!c.items||e.isEmptyObject(c.items)))throw Error("No Items sepcified");u++;c.ns=".contextMenu"+u;n[c.selector]=c.ns;q[c.ns]=c;c.trigger||(c.trigger="right");t||(d.on({"contextmenu:hide.contextMenu":f.hideMenu,"prevcommand.contextMenu":f.prevItem,"nextcommand.contextMenu":f.nextItem,"contextmenu.contextMenu":f.abortevent,"mouseenter.contextMenu":f.menuMouseenter,"mouseleave.contextMenu":f.menuMouseleave},".context-menu-list").on("mouseup.contextMenu",
".context-menu-input",f.inputClick).on({"mouseup.contextMenu":f.itemClick,"contextmenu:focus.contextMenu":f.focusItem,"contextmenu:blur.contextMenu":f.blurItem,"contextmenu.contextMenu":f.abortevent,"mouseenter.contextMenu":f.itemMouseenter,"mouseleave.contextMenu":f.itemMouseleave},".context-menu-item"),t=!0);d.on("contextmenu"+c.ns,c.selector,c,f.contextmenu);switch(c.trigger){case "hover":d.on("mouseenter"+c.ns,c.selector,c,f.mouseenter).on("mouseleave"+c.ns,c.selector,c,f.mouseleave);break;case "left":d.on("click"+
c.ns,c.selector,c,f.click)}c.build||p.create(c);break;case "destroy":if(c.selector){if(n[c.selector]){var g=e(".context-menu-list").filter(":visible");g.length&&g.data().contextMenuRoot.$trigger.is(c.selector)&&g.trigger("contextmenu:hide",{force:!0});try{q[n[c.selector]].$menu&&q[n[c.selector]].$menu.remove(),delete q[n[c.selector]]}catch(h){q[n[c.selector]]=null}d.off(n[c.selector])}}else d.off(".contextMenu .contextMenuAutoHide"),e.each(n,function(a,b){d.off(b)}),n={},q={},u=0,t=!1,e("#context-menu-layer, .context-menu-list").remove();
