...
this.showStopsLines=function(){for(var a=0;a<this.linesKeys.length;a++)for(var b=0;b<this.selectedStops[this.linesKeys[a].key].length;b++)this.selectedStops[this.linesKeys[a].key][b].show()};this.showHour=function(a,b){$.ajax({type:"GET",url:HOST+"/horario/"+a,async:!1,jsonpCallback:"busca",contentType:"application/json",dataType:"jsonp",cache:!1,success:function(c){var d="";ts="undefined"==typeof c.util?0:c.util.length;0<ts&&(d+="<h6>Dias Ut&eacute;is</h6><ul>");for(var e=0;e<ts;e++)d+="<li"+("t"==
c.util[e].especial?' class="especial"':"")+">"+c.util[e].horario+"</li>";0<ts&&(d+="</ul>");ts="undefined"==typeof c.sabado?0:c.sabado.length;0<ts&&(d+="<h6>S&aacute;bado</h6><ul>");for(e=0;e<ts;e++)d+="<li"+("t"==c.util[e].especial?' class="especial"':"")+">"+c.sabado[e].horario+"</li>";0<ts&&(d+="</ul>");ts="undefined"==typeof c.domingo?0:c.domingo.length;0<ts&&(d+="<h6>Domingo</h6><ul>");for(e=0;e<ts;e++)d+="<li"+("t"==c.util[e].especial?' class="especial"':"")+">"+c.domingo[e].horario+"</li>";
0<ts&&(d+="</ul>");""==d&&(d="<p>N&atilde;o foi encontrado hor&aacute;rios</p>");"undefined"==typeof b&&(b=$("[data-linha="+a+"]").find(".codigos>span").html()+" - "+$("[data-linha="+a+"]").find(".linhas>span").html());$("#hora").html(d).dialog({title:b,width:235,height:300})}})};this.showStopLine=function(){(this.showStopsLine=!this.showStopsLine)?this.showStopsLines():this.hideStopsLines()};this.isSearching=!1;this.searchInProgress=null;this.showStops=function(){if(this.loadedStops){null==this.MarkerClustererStop&&
...
"route"==i[k]&&(d=b[0].address_components[f].long_name);f="Rua ?";""!=d&&(f=d);""!=g&&(f+=", "+g);""!=e&&(f+=" - "+e);a.city=e;a.name=f;a.marker.setTitle(f)}else a.city="",a.name="Parada",a.marker.setTitle("Parada")})};""==e?this.updateInfo():this.setTitle(this.name);d?this.select():this.deselect()};this.taxi=function(a,b,c,d,e){void 0==c&&(c=!1);void 0==d&&(d=!1);void 0==e&&(e="");this.map=a;this.marker=new google.maps.Marker({position:b,draggable:c,map:this.map});this.city="";this.selected=null;
